...
public class MusicVisualizerController {
    ...
    private void initializeGUI() {
        ...
        // Add buttons to HBox
        buttonbox.getChildren().addAll(playButton, stopButton, uploadButton);

        // Add HBox to the layout
        visualizationArea.getChildren().add(buttonbox);
        visualizationArea.setPadding(new Insets(250, 0, 0, 0)); // Adjust the top padding as needed, where buttons are
    }
